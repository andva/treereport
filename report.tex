...
It follows the report by \citet{Palubicki} where the tree is grown from the current buds while taking the environment in consideration.


\subsection{Growing}
The growing is done in several steps where the environment is checked to find the optimal growth direction for each branch of the tree.
